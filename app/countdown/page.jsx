  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto" data-animate="countdown">
              {[
            ...
            <div className="pt-8">
              <button className="px-10 py-4 bg-accent text-accent-foreground rounded-sm hover:bg-accent/90 transition-all">
                <span className="uppercase tracking-wider text-sm font-medium">Pre-Register Now</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-24 px-4 border-t border-border">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-medium tracking-tight mb-12 text-center">Important Dates</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { date: 'Feb 01, 2026', event: 'Registration Opens', status: 'Upcoming' },
              { date: 'Mar 01, 2026', event: 'Registration Closes', status: 'Upcoming' },
              { date: 'Mar 15, 2026', event: 'Event Begins', status: 'Upcoming' },
            ].map((milestone, index) => (
              <div
                key={index}
