...
const PlasmaFlow = () => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-30">
        ...
        <div className="absolute top-[20%] left-[20%] w-[300px] h-[300px] bg-cyan-400 rounded-full mix-blend-screen filter blur-[80px] animate-blob" />
        <div className="absolute top-[60%] right-[20%] w-[250px] h-[250px] bg-blue-500 rounded-full mix-blend-screen filter blur-[80px] animate-blob animation-delay-2000" />
        <div className="absolute bottom-[20%] left-[40%] w-[350px] h-[350px] bg-white rounded-full mix-blend-screen filter blur-[100px] animate-blob animation-delay-4000" />
                        ...
                        <div className="flex flex-col md:flex-row gap-12 items-center">
                            <div className="flex-1">
                                <div className="mb-4 flex items-center gap-2">
                                    ...
                                    <span className="text-cyan-200/60 text-xs font-mono tracking-[0.2em] uppercase">Fusion Core Active</span>
                                </div>

                                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 uppercase tracking-tight">
                                    Clean <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-white">Energy</span>
                                </h1>

                                <p className="text-cyan-100/70 mb-8 leading-relaxed text-lg">
                                    ECO-CORE is pioneering micro-fusion reactors and next-gen solar filaments.
                                    Our goal is unlimited, zero-emission energy for the entire Ingenium network.
                                </p>
