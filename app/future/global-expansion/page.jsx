...
const UniversityNode = ({ cx, cy, delay, name }) => (
    <g className="group cursor-pointer">
        ...
        <g className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <rect x={cx + 10} y={cy - 10} width="120" height="24" rx="2" className="fill-black/80 stroke-violet-500/30" />
            <text x={cx + 20} y={cy + 6} className="fill-violet-300 text-[10px] font-mono tracking-wider">{name}</text>
            <line x1={cx} y1={cy} x2={cx + 10} y2={cy} className="stroke-violet-500/50" />
        </g>
    </g>
);
...
export default function GlobalExpansionPage() {
    ...
    return (
        <PageTransitionWrapper>
            <main ref={mapRef} className="relative min-h-screen bg-[#050308] overflow-hidden selection:bg-violet-500/30 font-sans">
                <StarField />
                ...
                <div className="relative z-10 container mx-auto px-4 py-20 min-h-screen flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="w-full md:w-1/3 content-block">
                        <div className="mb-2 flex items-center gap-2">
                            ...
                            <span className="text-violet-500/50 font-mono text-xs tracking-[0.2em]">VISION 2026</span>
                        </div>
                        ...
                        <p className="text-violet-200/60 leading-relaxed mb-8 border-l-2 border-violet-500/20 pl-4">
                            Ingenium escapes the boundaries of the local. By 2026, we establish a neural network of innovation across 50+ international universities, creating a seamless exchange of ideas, code, and culture.
                        </p>

                        <div className="grid grid-cols-2 gap-4 mb-8">
                            <div className="bg-violet-900/10 border border-violet-500/20 p-4 rounded-lg">
                                <div className="text-2xl font-bold text-white mb-1">50+</div>
                                <div className="text-[10px] text-violet-400 uppercase tracking-wider">Partner Unis</div>
                            </div>
                            <div className="bg-violet-900/10 border border-violet-500/20 p-4 rounded-lg">
                                <div className="text-2xl font-bold text-white mb-1">12</div>
                                <div className="text-[10px] text-violet-400 uppercase tracking-wider">Countries</div>
                            </div>
                            <div className="bg-violet-900/10 border border-violet-500/20 p-4 rounded-lg">
                                <div className="text-2xl font-bold text-white mb-1">24/7</div>
                                <div className="text-[10px] text-violet-400 uppercase tracking-wider">Global Hackathons</div>
                            </div>
                        </div>
                    ...
                    <div className="w-full md:w-2/3 h-[500px] relative bg-[#080510] border border-violet-500/20 rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(139,92,246,0.1)] map-node">
                        {/* World Map SVG Representation */}
                        <div className="absolute inset-0 opacity-20">
                            <svg viewBox="0 0 800 400" className="w-full h-full text-violet-500 fill-current">
                                {/* Simplified World Map Path (Low Poly style) */}
                                <path d="M150,100 Q180,80 200,110 T250,150 T300,120 T350,180 T200,250 T100,200 Z" /> {/* Americas approximation */}
                                <path d="M380,80 Q450,50 500,80 T550,150 T500,250 T400,280 T350,200 Z" /> {/* Europe/Africa approximation */}
                                <path d="M580,80 Q650,60 700,90 T750,180 T700,250 T600,280 T550,200 Z" /> {/* Asia/Aus approximation */}
                            </svg>
                        </div>
                        ...
                        <svg className="absolute inset-0 w-full h-full">
                            ...
                            <UniversityNode cx="250" cy="150" delay="0.8" name="Stanford Node" />
                            <UniversityNode cx="500" cy="250" delay="1.8" name="Cape Town Link" />
