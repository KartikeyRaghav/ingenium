...
const BlueprintZone = ({ x, y, width, height, title, description, active, onClick }) => (
    ...
    >
        ...
        <text x={x + 10} y={y + 20} className="fill-blue-300 text-xs font-mono uppercase tracking-widest pointer-events-none select-none">{title}</text>
    </g>
);
        ...
        <PageTransitionWrapper>
            <main className="relative min-h-screen bg-[#02040a] overflow-hidden selection:bg-blue-500/30 font-sans">
                ...
                <div className="relative z-10 container mx-auto px-4 py-20 flex flex-col lg:flex-row gap-12 perspective-[1000px]">
                    ...
                    <div ref={containerRef} className="lg:w-2/3 order-1 lg:order-2 h-[400px] lg:h-[600px] relative pointer-events-auto cursor-crosshair">
                        <div ref={tiltRef} className="w-full h-full bg-[#050a15] border border-blue-500/20 rounded-xl overflow-hidden shadow-[0_0_50px_rgba(59,130,246,0.15)] relative transform-style-3d">
                            ...
                            <div className="absolute inset-0 w-full h-[2px] bg-blue-400/50 shadow-[0_0_15px_rgba(59,130,246,0.8)] animate-scan-line pointer-events-none" />
