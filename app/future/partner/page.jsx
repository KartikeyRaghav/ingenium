...
const ScannerLine = () => (
    <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-violet-500 to-transparent opacity-50 animate-scan-fast pointer-events-none" />
);
        ...
        <PageTransitionWrapper>
            <main className="min-h-screen bg-[#050308] text-violet-100 relative overflow-hidden selection:bg-violet-500/30 selection:text-white">
                ...
                <div className="fixed inset-0 pointer-events-none">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-violet-900/10 blur-[120px] rounded-full" />
                    <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-blue-900/10 blur-[100px] rounded-full" />
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
                    ...
                    <div className="text-center mb-16 relative">
                        <Link href="/future" className="absolute left-0 top-0 text-violet-500 hover:text-white transition-colors font-mono text-xs flex items-center gap-2">
                            ← RETURN TO NEXUS
                        </Link>
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
                            Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-blue-400">Chronoverse</span>
                        </h1>
                        <p className="text-lg text-violet-200/60 max-w-2xl mx-auto leading-relaxed">
                            Partner with Ingenium to shape the timeline. Gain access to cutting-edge research,
                            global talent networks, and direct influence on the next century of innovation.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {[
                                    { title: "Early Access", desc: "Priority access to quantum computing and bio-augmentation research data before public release.", icon: "🔓" },
                                    { title: "Global Network", desc: "Connect with Tier-1 innovators and institutions across the synchronized timeline.", icon: "🌐" },
                                    { title: "Brand Future", desc: "Secure your organization's legacy by embedding it into the structural roadmap of 2030+.", icon: "✨" },
                                    { title: "Talent Pipeline", desc: "Direct recruitment channels for the engineers and visionaries of tomorrow.", icon: "👥" }
                                ].map((item, i) => (
                                    <div key={i} className="group relative p-6 bg-white/5 border border-white/10 hover:border-violet-500/50 transition-all duration-300 backdrop-blur-sm overflow-hidden">
                                        ...
                                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-violet-300 transition-colors">{item.title}</h3>
                                        <p className="text-sm text-violet-200/50 leading-relaxed">{item.desc}</p>
                                    </div>
                                ))}
                            </div>

                            {/* Stylized Quote */}
                            <div className="relative p-8 border-l-2 border-violet-500/50 bg-gradient-to-r from-violet-500/10 to-transparent">
                                <p className="text-xl font-light italic text-violet-100/80 mb-4">
                                    "The future is not something we enter. The future is something we create."
                                </p>
                                <span className="font-mono text-xs text-violet-400 uppercase tracking-widest">— Leonardo Da Vinci (Simulated)</span>
                            </div>
                        </div>
                                ...
                                <div className="p-8">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        <div className="space-y-1">
                                            <label className="text-xs font-mono text-violet-300 uppercase tracking-wider block">Organization Name</label>
                                            <input
                                                type="text"
                                                name="orgName"
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            <div className="space-y-1">
                                                <label className="text-xs font-mono text-violet-300 uppercase tracking-wider block">Contact Person</label>
                                                <input
                                                    type="text"
                                                    name="contactPerson"
                                            ...
                                            <div className="space-y-1">
                                                <label className="text-xs font-mono text-violet-300 uppercase tracking-wider block">Email Frequency</label>
                                                <input
                                                    type="email"
                                                    name="email"
                                        ...
                                        <div className="space-y-1">
                                            <label className="text-xs font-mono text-violet-300 uppercase tracking-wider block">Partnership Tier Interest</label>
                                            <div className="grid grid-cols-3 gap-2">
                                                {["Gold", "Silver", "Bronze"].map(tier => (
                                                    <button
                                                        ...
                                                        className={`py-2 text-sm border transition-all ${formData.tier === tier
                                        ...
                                        <div className="space-y-1">
                                            <label className="text-xs font-mono text-violet-300 uppercase tracking-wider block">Message Payload</label>
                                            <textarea
                                                name="message"
