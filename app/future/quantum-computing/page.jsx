    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            for (let i = 0; i < particleCount; i++) {
                ...
                const x = centerX + Math.cos(angle) * (radius * Math.sin(time * 0.5 + i));
                const y = centerY + Math.sin(angle * 1.5) * (radius * Math.cos(time * 0.3 + i));
                ...
                <div className="relative z-10 container mx-auto px-4 py-20 min-h-screen flex items-center justify-center">
                    <div className="max-w-xl text-center">
                        <div className="mb-4 inline-block">
                            ...
                            <span className="text-[10px] font-mono text-violet-300 uppercase tracking-[0.3em]">Research Module</span>
                        </div>
                        ...
                        <p className="text-violet-200/60 mb-8 leading-relaxed text-lg backdrop-blur-sm bg-black/20 p-4 rounded-xl border border-violet-500/10">
                            Harnessing the laws of quantum mechanics to solve problems beyond the reach of classical computers.
                            Our Q-BIT-99 algorithm is optimizing complex logistical networks in real-time.
                        </p>

                        <div className="grid grid-cols-3 gap-4 text-center">
                            <div className="p-4 rounded-lg bg-violet-900/10 border border-violet-500/20">
                                <div className="text-2xl font-bold text-white mb-1">99</div>
                                <div className="text-[9px] text-violet-400 uppercase tracking-wider">Qubits</div>
                            </div>
                            <div className="p-4 rounded-lg bg-violet-900/10 border border-violet-500/20">
                                <div className="text-2xl font-bold text-white mb-1">0.02ms</div>
                                <div className="text-[9px] text-violet-400 uppercase tracking-wider">Coherence</div>
                            </div>
                            <div className="p-4 rounded-lg bg-violet-900/10 border border-violet-500/20">
                                <div className="text-2xl font-bold text-white mb-1">99%</div>
                                <div className="text-[9px] text-violet-400 uppercase tracking-wider">Fidelity</div>
                            </div>
                        </div>
                    </div>
                </div>
