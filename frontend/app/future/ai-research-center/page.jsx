        ...
        <div className="absolute top-8 left-8 z-50">
          <Link href="/future">
            <button className="flex items-center gap-2 text-green-400/60 hover:text-white transition-colors group">
              ...
              <span className="text-[10px] font-mono tracking-widest uppercase hidden md:block bg-black/50 px-2 py-1 rounded">
                Return to Roadmap
              </span>
            </button>
          </Link>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="flex-1">
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 uppercase tracking-tighter">
                  AI{" "}
                  <span className="text-green-500 animate-pulse">Research</span>{" "}
                  <br /> Center
                </h1>
                <p className="text-green-100/70 mb-8 leading-relaxed">
                  A sanctuary for synthetic intelligence. We are constructing a
                  GPU-dense cluster dedicated to solving humanity's most complex
                  problems through Deep Learning, Neural Interfaces, and
                  Autonomous Systems.
                </p>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 group">
                      ...
                      <span className="text-sm text-green-400 group-hover:text-white transition-colors">
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="w-full md:w-80 font-mono text-xs">
                <div className="bg-[#0a0a0a] border border-green-500/20 p-4 rounded h-64 overflow-hidden relative">
                  <div className="text-green-500/50 mb-2 border-b border-green-500/10 pb-2">
                    SYS_LOG.txt
                  </div>
