        ...
        <div className="relative z-10 container mx-auto px-4 py-20 min-h-screen flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 z-20">
            ...
            <p className="text-blue-200/60 mb-8 leading-relaxed text-lg max-w-xl">
              Advancing humanity's reach into the cosmos. The ASTRO-X initiative
              focuses on next-generation propulsion, satellite constellations,
            ...
            <div className="space-y-4 font-mono text-xs text-blue-400">
              <div className="flex items-center gap-4 p-3 border border-blue-500/20 rounded bg-blue-900/10 hover:bg-blue-900/20 transition-colors cursor-pointer group">
                ...
                <span className="flex-1 text-blue-200/80 group-hover:text-white">
          ...
          <div className="w-full md:w-1/2 h-125 relative flex items-center justify-center perspective-[1000px]">
            {/* 3D Plane Effect */}
            <div className="relative w-100 h-100 transform rotate-x-60">
              {/* Sun/Center */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-blue-500 rounded-full blur-2xl opacity-40 animate-pulse" />
            ...
            <div className="absolute bottom-10 right-10 text-right">
              <div className="text-[40px] font-bold text-white/10 font-mono">
                ASTRO-X
              </div>
            </div>
          </div>
