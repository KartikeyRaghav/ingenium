        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="space-y-3">
              <p className="text-[12px] text-emerald-500/50 uppercase tracking-widest ml-2 italic">
              ...
              {problemStatements.map((ps, idx) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <span className="text-[12px] font-bold text-emerald-500 tracking-tighter">
                      PS_MOD_0{ps.id}
                    </span>
                    <div
                      className={
            ...
            <div className="p-5 bg-red-500/5 border border-red-500/20 rounded-xl">
              ...
              <p className="text-[12px] text-gray-500 leading-relaxed italic mb-4">
          ...
          <div className="lg:col-span-8 space-y-6">
                        ...
                        <ul className="space-y-3">
                          {problemStatements[activeProblem].tasks.map(
                            (task, i) => (
                              <li
                                key={i}
                                className="flex gap-3 text-[13px] text-gray-400 leading-snug"
                              >
                        ...
                        <ul className="space-y-3">
                          {problemStatements[activeProblem].rules.map(
                            (rule, i) => (
                              <li
                                key={i}
                                className="flex gap-3 text-[13px] text-gray-500 italic leading-snug border-b border-white/5 pb-2"
                              >
                                {rule}
                              </li>
                            ),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-black/40 border border-emerald-500/10 p-8 rounded-3xl flex flex-col justify-between">
                ...
                <p className="text-[10px] text-red-600 mt-6 uppercase tracking-widest text-center border border-white/5 py-2">
...
function StatBox({ label, value, icon }) {
  return (
    <div className="px-6 py-3 bg-emerald-500/5 border border-emerald-500/20 rounded-xl flex items-center gap-3">
      ...
      <div>
        <span className="block text-[10px] text-emerald-500/50 uppercase font-bold tracking-widest">
          {label}
        </span>
...
function PrizeTier({ rank, amount }) {
  return (
    <div className="text-center p-2 bg-black/40 border border-emerald-500/10 rounded-lg">
      <div className="text-[10px] text-emerald-500/50 mb-1">{rank}</div>
...
function ContactInfo({ name, role }) {
  return (
    <div className="flex justify-between items-center border-b border-white/5 pb-2">
      ...
      <span className="text-[11px] text-emerald-500/60 font-bold uppercase italic">
        {role}
      </span>
    </div>
  );
