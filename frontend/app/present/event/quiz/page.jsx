            ...
            <div className="p-6 bg-black/40 border border-white/5 rounded-2xl">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {knowledgeDomains.map((tag) => (
                  <span
                    key={tag}
                    className="text-[11px] bg-white/5 px-2 py-1 rounded border border-white/10 text-amber-300 uppercase"
                  >
                    {" "}
                    {tag}
                  </span>
                ))}
                <span className="text-[11px] bg-white/5 px-2 py-1 rounded border border-white/10 text-amber-300 uppercase">
                  General Knowledge
                </span>
              </div>
              <Link
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                  <div className="p-5 bg-amber-500/5 border-l-2 border-amber-500 rounded-r-xl">
                    <h4 className="text-[12px] text-amber-500 uppercase font-bold mb-2">
                      Protocol_Status
                    </h4>
              ...
              <div className="mt-8 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-[12px] text-amber-500 uppercase font-bold tracking-widest">
                      Logic_Framework
                    </div>
                ...
                <div className="text-[12px] text-gray-500 uppercase font-bold tracking-tighter max-w-xs text-right">
...
function BountyNode({ rank, amount, label }) {
  return (
    <div className="text-center group">
      <div className="text-[10px] text-amber-500 uppercase mb-1 font-bold tracking-tighter">
        {rank}_TIER
      </div>
      <div className="text-xl font-black text-white italic group-hover:scale-110 transition-transform">
        ₹{amount}
      </div>
      <div className="text-[9px] text-amber-400/40 uppercase mt-1 font-bold">
        {label}
      </div>
    </div>
  );
