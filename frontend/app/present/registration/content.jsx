...
const EVENT_CONFIG = {
  "General Entry": { teamSize: 1, color: "#94a3b8", sector: "GEN-00" },
  glider: {
  ...
  matiks: { name: "Matiks", teamSize: 2, color: "#a855f7", sector: "MAT-01" },
  monsoon_water: {
  ...
  av: { name: "Analog Verse", teamSize: 2, color: "#a3e635", sector: "ELE-02" },
  web: {
  ...
  rw: { name: "Robowars", teamSize: 4, color: "#f43f5e", sector: "RBT-01" },
  rs: { name: "Robosoccer", teamSize: 3, color: "#f43f5e", sector: "RBT-02" },
  lf: {
    name: "Line Follower",
    teamSize: 2,
    color: "#f43f5e",
